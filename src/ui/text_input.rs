//! Single-line text input with selection, cursor, and clipboard.
//!
//! Adapted from gpui's `examples/input.rs`. Trimmed to a single line and
//! styled to match the app theme; otherwise the selection / cursor /
//! IME / clipboard behavior is the same.
...
/// Register the key bindings the TextInput listens for. Call this once
